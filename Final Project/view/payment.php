...
if(!isset($_SESSION['eventname'])) {
    header('location: purchaseTicket.php');
}
...
<body>
    ...
    <form action="../controller/payment_check.php" method="post">
        ...
        <input type="number" id="amount" name="amount" value="<?php echo $_SESSION['totalamount']; ?>" required><br><br>
        
        <label for="event_name">Event Name:</label><br>
        <input type="text" id="event_dropdown" name="event_dropdown" value="<?php echo $_SESSION['eventname']; ?>" required><br><br>
        ...
        <input type="text" id="bkash_number" name="bkash_number" value="" required><br><br>
