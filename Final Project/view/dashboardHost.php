...
<div style="background-color: white; padding: 10px;">
  ...
  <a href="attendeelist.php" style="color: black; text-decoration: none; font-weight: bold;">Attendee List</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="searchEvent.php" style="color: black; text-decoration: none; font-weight: bold;">Search</a>&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="venuelist.php" style="color: black; text-decoration: none; font-weight: bold;">Venue List</a>&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <a href="../controller/logout.php" style="color: black; text-decoration: none; font-weight: bold;">Log Out</a>
</div>
