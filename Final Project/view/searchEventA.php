...
<script src="../assets/js/searchdataA.js"></script>
...
<section>
    <fieldset>
        ...
        <form method="post" action="../controller/searchController.php" enctype="multipart/form-data" onsubmit="searchEventA(event)">
